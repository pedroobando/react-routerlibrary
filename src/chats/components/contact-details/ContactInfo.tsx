...
import { Client } from '@/chats/interfaces/chat.interface';

interface Props {
  client: Client;
}

export const ContactInfo: FC<Props> = ({ client }) => {
  return (
    <div className="p-4">
      <div className="flex flex-col items-center pb-6 border-b">
        ...
        <p className="text-sm text-muted-foreground font-bold">{client.currentPlan.toLocaleUpperCase()}</p>
